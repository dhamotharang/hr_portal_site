...
<div class="container">
    <div class="row justify-content-center">
        ...
        <span class="d-flex justify-content-center mb-5 mt-5" style="font-family: cursive; font-size: 3rem"> Welcome  {{ Auth::user()->name }}  </span> 
        <div class="card mb-5">
                <div style="background-color: #707CD2;color: #fff" class="card-header d-flex justify-content-center" style="font-family: cursive; font-size: 1rem"> latest Balance for you</div>
            ...
            <div class="card mb-5">
                    <div style="background-color: #707CD2;color: #fff" class="card-header d-flex justify-content-center" style="font-family: cursive; font-size: 1rem"> latest HR notification for you</div>
                                 ...
                                 @foreach($last_hr_notes as $Hnote)
                                     <div class="col-md-12">
                                         <div class="card mb-3" style="min-width: 20rem;margin-left:5px">
                                             <div style="background-color: #707CD2;color: #fff" class="card-header  text-white">
                                                Hr Note 
                                             </div>
                                             <div style="background-color: lavender" class="card-body">
            ...
            <div class="card mb-5">
                    <div style="background-color: #707CD2;color: #fff" class="card-header d-flex justify-content-center" style="font-family: cursive; font-size: 1rem"> latest HR General Notifications</div>
            ...
            @else
            <span class="d-flex justify-content-center mb-5 mt-10" style="font-family: cursive; font-size: 3rem ;margin-top:200px"> Welcome Mr:  {{ Auth::user()->name }}  </span> 
            @endif
        </div>
    </div>
</div>
