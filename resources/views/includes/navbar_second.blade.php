            ...
            <div class="navbar-header">
                ...
                <div style="margin-left: 580px" class="d-none d-md-block text-center">
                    <a style="text-align: center" class="sidebartoggler waves-effect waves-light d-flex align-items-center side-start" href="{{url("home")}}" data-sidebartype="mini-sidebar">
                        <span style="font-family:cursive" class="navigation-text ml-3"><span style="color: crimson;font-size: 30px;font-weight: bold">H</span>R <span style="color: crimson;font-size: 30px;font-weight: bold">P</span>ORTAL</span>
                    </a>
                </div>
                @else
                                ...
                                <li>
                                    <div class="message-center message-body">
                                        ...
                                        <a href="{{ url('/register') }}" class="message-item">
                                            ...
                                            <h5 style="font-family: cursive; font-size: 16px" class="message-title"><i class="fas fa-user-plus mr-2 ml-1"></i>Add New Employee</h5>
                                        </a>
                                        <!-- all -->
                                        <a href="{{ url('upload') }}" class="message-item">

                                            <h5 style="font-family: cursive; font-size: 16px" class="message-title"><i class="fas fa-plus-circle mr-2 ml-1"></i>Add All</h5>
                                        </a>
                                        <!-- search -->
                                        <a href="{{ url('employees') }}" class="message-item">

                                          <h5 style="font-family: cursive; font-size: 16px" class="message-title"><i class="fas fa-search mr-2 ml-1"></i>Search Employee</h5>
                                       </a>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div class="message-center message-body">
                                        ...
                                        <a href="{{url("employees_balance/search_balance")}}" class="message-item">
                                            ...
                                            <h5 style="font-family: cursive; font-size: 16px" class="message-title"><i class="fas fa-calculator mr-2 ml-1"></i>Add New Employee Balance</h5>
                                        </a>
                                        <!-- all -->
                                        <a href="{{url("upload_balance")}}" class="message-item">

                                            <h5 style="font-family: cursive; font-size: 16px" class="message-title"><i class="fas fa-plus-circle mr-2 ml-1"></i>Add To All</h5>
                                        </a>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <li>
                                    <div class="message-center message-body">
                                        ...
                                        <a href="{{url("employees_notify/search_notification")}}" class="message-item">
                                            ...
                                            <h5 style="font-family: cursive; font-size: 16px" class="message-title"><i class="fas fa-bell mr-2 ml-1"></i>Add Employee Notification</h5>
                                        </a>
                                        <!-- all -->
                                ...
                                <li>
                                    <div class="message-center message-body">
                                        ...
                                        <a href="{{url("generaklNotifications")}}" class="message-item">
                                            ...
                                            <h5 style="font-family: cursive; font-size: 16px" class="message-title"><i class="fas fa-bell mr-2 ml-1"></i>Add General Notification</h5>
                                        </a>
                                    </div>
                                </li>
                            </ul>
